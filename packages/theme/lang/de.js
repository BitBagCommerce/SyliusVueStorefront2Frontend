...
export default {
  ...
  'Sylius integration powered by BitBag': 'Sylius-Integration unterstützt von BitBag',
  ...
  'Empty cart desc': 'Sieht so aus, als hätten Sie der Tasche noch keine Artikel hinzugefügt. Beginnen Sie mit dem Einkaufen, um es auszufüllen.',
  'Billing': 'Abrechnung',
  'First name': 'Vorname',
  'Last name': 'Nachname',
  ...
  'Safety': 'Sicherheit',
  'It carefully packaged with a personal touch': 'Es sorgfältig verpackt mit einer persönlichen Note',
  'Easy shipping': 'Einfacher Versand',
  'You’ll receive dispatch confirmation and an arrival date': 'Sie erhalten eine Versandbestätigung und ein Ankunftsdatum',
  'Changed your mind?': 'Ihre Meinung geändert?',
  'Rest assured, we offer free returns within 30 days': 'Seien Sie versichert, wir bieten kostenlose Rücksendungen innerhalb von 30 Tagen an',
  'Amount': 'Menge',
  ...
  'Product has been added to the cart': 'Produkt wurde dem Warenkorb hinzugefügt',
  ...
  'No shipping methods are available for selected country. Please choose a different country.': 'Für das ausgewählte Land sind keine Versandarten verfügbar. Bitte wählen Sie ein anderes Land.',
