...
const addCouponToCart = {
  correctCoupon: {
    ...
    promotionCoupon: {
      ...
      promotion: {
        name: 'Christmas',
        description: 'Repellat autem ipsam quidem nostrum aut rerum.',
        __typename: 'Promotion',
      },
      __typename: 'PromotionCoupon',
    },
...
const createCart = {
  cart: {
    cartToken: '/api/v2/shop/orders/VCiHr29mXv',
  },
};
  ...
  paymentMethods: [
    {
      ...
      description: 'Neque et aut consectetur sed quos unde.',
    },
    {
      label: 'Bank transfer',
      value: 'bank_transfer',
      description: 'Et dolorum minima debitis aperiam sed inventore id.',
    },
  ],
};
  ...
  shippingMethods: [
    {
      label: 'UPS',
      value: 'ups',
      description: 'Assumenda excepturi accusamus illo et ad architecto.',
      cost: 3.96,
    },
  ],
};
