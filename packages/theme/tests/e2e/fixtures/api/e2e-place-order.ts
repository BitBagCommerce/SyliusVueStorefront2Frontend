const apiData = {
  ...
  createCart: [
    { cartToken: '/api/v2/shop/orders/jeSLZ2pcZe' },
    { cartToken: '/api/v2/shop/orders/Aef2uNyk~x' },
    { cartToken: '/api/v2/shop/orders/s_5DRXXX9O' },
    { cartToken: '/api/v2/shop/orders/NvobUV_E2Z' },
  ],
  getCart: [
    {
      tokenValue: 'jeSLZ2pcZe',
      localeCode: 'en_US',
      total: 0,
      taxTotal: 0,
      shippingTotal: 0,
    ...
    },
    {
      ...
      billingAddress: null,
      shipments: {
        id: '/api/v2/shop/shipments/425',
        _id: 425,
        method: { code: 'ups', __typename: 'ShippingMethod' },
        __typename: 'Shipment',
      },
      payments: {
        id: '/api/v2/shop/payments/425',
        _id: 425,
  ...
  createOrder: [
    { number: '000000010', tokenValue: 'jeSLZ2pcZe', __typename: 'Order' },
  ],
};
