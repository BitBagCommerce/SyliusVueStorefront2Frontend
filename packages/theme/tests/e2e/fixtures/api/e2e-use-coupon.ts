const apiData = {
  ...
  createCart: [
    { cartToken: '/api/v2/shop/orders/6sN40irxrP' },
    { cartToken: '/api/v2/shop/orders/11lvb47_xy' },
    { cartToken: '/api/v2/shop/orders/3beYEeAJpu' },
  ],
  getCart: [
    {
      tokenValue: '6sN40irxrP',
      localeCode: 'en_US',
      total: 0,
      taxTotal: 0,
      shippingTotal: 0,
    ...
    },
    {
      ...
      billingAddress: null,
      shipments: {
        id: '/api/v2/shop/shipments/429',
        _id: 429,
        method: { code: 'ups', __typename: 'ShippingMethod' },
        __typename: 'Shipment',
      },
      payments: {
        id: '/api/v2/shop/payments/429',
        _id: 429,
  ...
  createOrder: [
    { number: '000000106', tokenValue: '6sN40irxrP', __typename: 'Order' },
  ],
};
