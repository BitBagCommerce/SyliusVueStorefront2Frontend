const apiData = {
  ...
  createCart: [{ cartToken: '/api/v2/shop/orders/xTtD~PMMxO' }],
  getFirstProductId: [
    [
      {
  ...
  addToCart: [
    {
      ...
      billingAddress: null,
      shipments: {
        id: '/api/v2/shop/shipments/449',
        _id: 449,
        method: { code: 'ups', __typename: 'ShippingMethod' },
        __typename: 'Shipment',
      },
      payments: {
        id: '/api/v2/shop/payments/449',
        _id: 449,
      ...
      items: [
        {
          ...
          unitPrice: 5556,
          total: 5556,
          productName: 'Oversize white cotton T-Shirt',
          variantName: 'M',
          quantity: 1,
