...
import { BaseQuery, getProductsNotFilteredQuery, getProductsAttributesQuery, getMinimalProductsQuery } from './queries';
...
export async function getMinimalProduct(context, params, customQuery?: CustomQuery): Promise<any> {
  let pagination = {};
  let products = [];
